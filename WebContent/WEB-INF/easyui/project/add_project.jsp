...
<div id="dlg" class="easyui-layout" style="padding:10px 20px">
    ...
    <form id="user_form" method="post" >
        ...
        <div class="fitem">
            <label>下线日期:</label>
            <input id="discardTime" name="discardTime" class="easyui-datebox easyui-validatebox" >
        </div>
        <div class="fitem">
            <label>开发SVN:</label>
        ...
        <div class="fitem">
            <label>编译说明:</label>
            <textarea cols="33" rows="5" name="buildInfo"></textarea>
        </div>
        <div class="fitem">
            <label>备注:</label>
            <textarea cols="33" rows="5" name="memo"></textarea>
        </div>
    </form>
</div>
